...
// checked leaf at member inner -> member checked: calls crate::rust_std::str_and_char::escape_ascii_carrier::verify_escape_ascii_model_leaves_printable_bytes_unescaped
...
{
    crate::rust_std::str_and_char::escape_ascii_carrier::verify_escape_ascii_model_leaves_printable_bytes_unescaped(printable)
}
