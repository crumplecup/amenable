...
mechanism; `amenable_kani` now in progress, **771 → 348 sites** across
thirty-two fixes this session (two real `elicit_doc` matcher bugs
plus thirty named clusters — eleven generic contract types, eight
