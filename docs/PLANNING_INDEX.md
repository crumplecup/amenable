...
mechanism; `amenable_kani` now in progress, **771 → 355 sites** across
thirty fixes this session (two real `elicit_doc` matcher bugs
plus twenty-eight named clusters — eleven generic contract types, eight
