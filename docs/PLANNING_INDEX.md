...
mechanism; `amenable_kani` now in progress, **771 → 351 sites** across
thirty-one fixes this session (two real `elicit_doc` matcher bugs
plus twenty-nine named clusters — eleven generic contract types, eight
