...
mechanism; `amenable_kani` now in progress, **771 → 363 sites** across
twenty-eight fixes this session (two real `elicit_doc` matcher bugs
plus twenty-six named clusters — eleven generic contract types, seven
