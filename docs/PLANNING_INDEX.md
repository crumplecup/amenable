...
mechanism; `amenable_kani` now in progress, **771 → 359 sites** across
twenty-nine fixes this session (two real `elicit_doc` matcher bugs
plus twenty-seven named clusters — eleven generic contract types, eight
